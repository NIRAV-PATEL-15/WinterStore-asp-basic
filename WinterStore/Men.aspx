<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Men.aspx.cs" Inherits="WinterStore.Men" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:DataList ID="DataList1" runat="server"  DataSourceID="MensProduct"  RepeatColumns="3" RepeatDirection="Horizontal" Height="100%" style="width: 90%;margin:auto"  GridLines="Both" CssClass="card deck">
            <ItemTemplate>
             <div class="col mb-2">
 ...
 <hr style="border-radius:0px"/>
        ...
        <asp:SqlDataSource ID="MensProduct" runat="server" ConnectionString="<%$ ConnectionStrings:dbconnect %>" SelectCommand="SELECT pid, pname, pdesc, pcategory, pmrp, pprice, pimage FROM Products WHERE (pidealfor = 'Men') and (isActive = 0)"></asp:SqlDataSource>
